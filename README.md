...
**The code in my team is kind of legacy code with very high Cyclomatic complexity, i'll try to improve the cyclomatic complexity and modularize the code so that it follows single responsibility principle**
